...
############### regional errors
regional_errors = {}
regional_errors['NDM'] = np.loadtxt('NDM_Decreasing_regions_22-07-20_13:08:07.csv', delimiter=',')
regional_errors['GCN'] = np.loadtxt('GCN_Decreasing_regions_22-07-20_16:08:05.csv', delimiter=',')
regional_errors['MAR'] = np.loadtxt('MAR_ALL_regions_22-06-30_06:43:42.csv', delimiter=',')
regional_errors['ESM'] = np.loadtxt('ESM_Decreasing_regions_22-07-20_10:32:57.csv', delimiter=',')
