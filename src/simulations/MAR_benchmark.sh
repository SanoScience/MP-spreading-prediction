...
python3 simulation_MAR.py LMCI 8 13 0.5 2000000 2
echo "#"
python3 simulation_MAR.py LMCI 8 13 0 2000000 2
echo "#"
python3 simulation_MAR.py LMCI 8 13 1 2000000 2
echo "#"

echo "### EMCI ###"

python3 simulation_MAR.py EMCI 8 14 0.5 2000000 2
echo "#"
python3 simulation_MAR.py EMCI 8 14 0 2000000 2
echo "#"
